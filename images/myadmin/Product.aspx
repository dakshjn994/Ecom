...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <center><h2 class="title text-center">Add Item</h2></center><br />
    <center>
    <asp:TextBox ID="txtItemName" placeholder="Item Name" runat="server"></asp:TextBox><br /><br /><br />
        <center><div class="panel panel-default" style="width:50%;height:70%;margin-left:3%;">
            <h3 class="title text-center">Add First Image</h3>
        <asp:Image ID="imgProduct" Height="200px" Width="50%" ImageUrl="~/images/home/Default_image.png" runat="server"></asp:Image>
        ...
        <center><div class="panel panel-default"  style="width:50%;height:70%;margin-left:2%;">
            <h3 style="width:60%" class="title text-center">Add Second Image</h3>
        <asp:Image ID="imgProduct1" Height="200px" Width="50%" ImageAlign="Top" ImageUrl="~/images/home/Default_image.png" runat="server"></asp:Image>
        ...
        <asp:Image ID="imgProduct2" Height="200px" Width="50%" ImageAlign="Top" ImageUrl="~/images/home/Default_image.png" runat="server"></asp:Image>
    ...
    <asp:Button ID="btnImageSubmit" Width="60%" OnClick="btnImageSubmit_Click" CssClass="btn btn-info" runat="server" Text="Upload" /><br /><br />
        ...
        Category: <asp:DropDownList ID="ddlCategory" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" AutoPostBack="true" Width="20%" runat="server"></asp:DropDownList><br /><br />
            ...
            <asp:ListItem Text="5" Value="5"></asp:ListItem>
                ...
                <div id="Constraint1" runat="server">
    ...
    <asp:Button ID="btnConstraint" OnClick="btnConstraint_Click" CssClass="btn btn-default" runat="server" Text="Add" /><br /><br />
    ...
    <asp:Button ID="btnConstraint1" CssClass="btn btn-default" OnClick="btnConstraint1_Click" runat="server" Text="Add" /><br /><br />
    ...
    <asp:Button ID="btnConstraint2" OnClick="btnConstraint2_Click" CssClass="btn btn-default" runat="server" Text="Add" /><br /><br />
    ...
    <asp:Button ID="btnConstraint3" OnClick="btnConstraint3_Click" CssClass="btn btn-default" runat="server" Text="Add" /><br /><br />
    ...
    <asp:Button ID="btnConstraint4" OnClick="btnConstraint4_Click" CssClass="btn btn-default" runat="server" Text="Add" /><br /><br />
    <asp:TextBox ID="txtopt4" placeholder="All Options" Enabled="false" runat="server"></asp:TextBox><br /><br />
        ...
        <asp:TextBox ID="txtMRP" placeholder="M. R. P." runat="server"></asp:TextBox><br /><br />
        <asp:TextBox ID="txtSalePrice" placeholder="Sale Price" runat="server"></asp:TextBox><br /><br />
        <textarea id="TextArea1" placeholder="Description" style="width:30%" runat="server" rows="2" cols="20"></textarea><br /><br />
        <asp:TextBox ID="txtStock" placeholder="Available Goods" runat="server"></asp:TextBox><br /><br />
